...
class DianosaursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dianosaur" do
    assert_difference('Dianosaur.count') do
      post dianosaurs_url, params: { dianosaur: { genus: @dianosaur.genus, name: @dianosaur.name } }
    end
  ...
  test "should update dianosaur" do
    patch dianosaur_url(@dianosaur), params: { dianosaur: { genus: @dianosaur.genus, name: @dianosaur.name } }
